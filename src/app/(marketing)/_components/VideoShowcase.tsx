  ...
  return (
    <div className="relative  flex items-center justify-center w-[1200px]  py-6 h-[400px] ">
      <div className="flex items-center justify-center w-fit ">
        {/* First Video */}
        <div className=" relative z-10 scale-75 sm:scale-90 lg:hover:scale-95 opacity-100 translate-x-28 sm:translate-x-14 -rotate-[25deg] transition-all duration-300 p-4 ease-in-out rounded-md">
          <video
            src={videos[0].url}
