  ...
  return (
    <div className="relative  flex items-center justify-center w-[1200px]  py-6 h-[400px] ">
      <div className="flex items-center justify-center w-fit ">
        {/* First Video */}
        <div className=" relative z-10 scale-75 lg:scale-90 lg:hover:scale-95 opacity-100 translate-x-24 lg:translate-x-14 -rotate-[25deg] transition-all duration-300 p-4 ease-in-out rounded-md">
          <video
            src={videos[0].url}
        ...
        {/* Second Video */}
        <div className="relative z-20 scale-90 lg:scale-105 lg:hover:scale-110 opacity-100 transition-all duration-300 p-4 ease-in-out rounded-md">
          <video
            src={videos[1].url}
